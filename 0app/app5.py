...
tk.Label(header, text="⚡ ELEVEN ELEVEN CREW ⚡", font=("Montserrat", 24, "bold"), fg=ACCENT, bg=BG_MAIN).pack()
...
tk.Label(
    footer,
    text="🚀 Team Eleven Eleven Crew | Space Station Object Detection | Hackathon 2025 🚀",
